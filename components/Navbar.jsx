        ...
        <div className="max-w-4xl mx-auto flex flex-col sm:flex-row justify-center sm:justify-between items-center gap-3">
          <div className="flex flex-col sm:flex-row items-center gap-3 sm:gap-6">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-xs sm:text-sm font-medium">{t('address')}</span>
            </div>
          </div>
          <div className="flex flex-wrap items-center justify-center sm:justify-end gap-3 sm:gap-6">
            ...
            <div className="flex items-center space-x-2">
              ...
              <span className="text-xs sm:text-sm break-all text-center sm:text-left">{t('email')}</span>
            </div>

            {/* Language Selector */}
            <div className="flex items-center space-x-1.5 bg-cyan-700/80 px-2 py-1 rounded-md border border-cyan-400/40">
              <svg className="w-4 h-4 text-white flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div className="absolute right-0 mt-2 w-56 bg-white rounded-lg shadow-lg py-1 z-50 border border-gray-200">
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="text-sm font-medium text-gray-700">{t('nav_rostered')}</div>
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="text-sm font-medium text-gray-700 truncate">{t('nav_walkin')}</div>
