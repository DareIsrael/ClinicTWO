...
export default function Navbar() {
  ...
  const isActiveLink = (path) => {
    return pathname === path ? 'text-red-600 bg-red-50 font-semibold' : 'text-gray-700 hover:text-red-600 hover:bg-gray-50';
  };
        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex items-center space-x-1">
            ...
            <div className="relative" ref={dropdownRef}>
              <button
                ...
                className="ml-2 px-4 py-2 rounded-lg text-sm font-semibold bg-red-600 text-white hover:bg-red-700 transition-all duration-200 shadow-sm hover:shadow-md flex items-center space-x-1.5 whitespace-nowrap"
              >
                <span>Book Now</span>
                <svg 
            ...
            {isAuthenticated ? (
              <>
                ...
                <div className="relative group ml-1">
                  <button className="flex items-center space-x-2 text-gray-700 hover:text-red-600 px-2 py-2 rounded-lg text-xs font-medium transition-all duration-200 hover:bg-gray-50">
                    <div className="w-7 h-7 bg-red-600 rounded-full flex items-center justify-center text-white font-semibold text-xs shadow-sm">
              ...
              <div className="flex items-center space-x-2 ml-2">
                <Link 
                  href="/waitlist" 
                  className="px-3 py-2 rounded-lg text-xs font-semibold bg-red-600 text-white hover:bg-red-700 transition-all duration-200 shadow-sm hover:shadow-md whitespace-nowrap"
                >
                  Join Waitlist
                </Link>
              </div>
          ...
          <div className="md:hidden flex items-center space-x-3">
            ...
            <button
              ...
              className="inline-flex items-center justify-center p-2 rounded-lg text-gray-700 hover:text-red-600 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-red-600 focus:ring-offset-2 transition-all duration-200"
              aria-label="Menu"
            >
          ...
          <div className="md:hidden absolute top-full left-0 right-0 bg-white shadow-lg border-t border-gray-100 animate-fadeIn z-50">
            <div className="px-2 pt-2 pb-3 space-y-1">
              ...
              <div className="px-1 pt-2">
                ...
                <Link
                  href="https://ocean.cognisantmd.com/online-booking/7b15e604-ee55-4d68-909f-a6b8d6039554"
                  className="flex items-center space-x-2 px-3 py-2.5 rounded-lg mx-1 text-sm font-medium bg-red-50 text-red-600 hover:bg-red-100 transition-all duration-200"
                  onClick={closeMobileMenu}
                >
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                ...
                <Link
                  href="/book-appointment"
                  className="flex items-center space-x-2 px-3 py-2.5 rounded-lg mx-1 text-sm font-medium bg-red-50 text-red-600 hover:bg-red-100 transition-all duration-200 mt-1"
                  onClick={closeMobileMenu}
                >
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" />
              ...
              {isAuthenticated ? (
                ...
                <>
                  <Link
                    href="/waitlist"
                    className="flex items-center space-x-2 mx-1 px-3 py-2.5 rounded-lg text-sm font-semibold bg-red-600 text-white hover:bg-red-700 transition-all duration-200 shadow-sm"
                    onClick={closeMobileMenu}
                  >
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
