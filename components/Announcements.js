...
const Announcements = () => {
  ...
  return (
    <div className={`${getTypeStyles(announcement.type)} rounded-xl shadow-md transition-all duration-300 ${isExpanded ? 'p-4' : 'p-3'}`}>
      <div className="flex items-start space-x-3">
        {/* Icon */}
        ...
        <div className="flex-1 min-w-0">
          ...
          {/* Message Content */}
          <div className={`${isExpanded ? 'block' : 'line-clamp-2'} text-sm text-gray-600 leading-relaxed`}>
