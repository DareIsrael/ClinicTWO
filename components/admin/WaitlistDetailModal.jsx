      ...
      <div className="bg-white rounded-lg max-w-2xl w-full max-h-[85vh] overflow-y-auto relative shadow-xl border border-gray-200">
        ...
        <div className="p-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <dl className="space-y-3">
                <div>
                  ...
                  <dd className="text-sm text-gray-700">{entry.firstName} {entry.lastName}</dd>
                </div>
                <div>
                  <dt className="text-sm font-medium text-gray-500">Email</dt>
                  <dd className="text-sm text-gray-700">{entry.email}</dd>
                </div>
                <div>
                  <dt className="text-sm font-medium text-gray-500">Phone</dt>
                  <dd className="text-sm text-gray-700">{entry.cellPhone || 'N/A'}</dd>
                </div>
                <div>
                  <dt className="text-sm font-medium text-gray-500">Gender</dt>
                  <dd className="text-sm text-gray-700">{entry.gender || 'N/A'}</dd>
                </div>
                <div>
            ...
            <div>
              <h3 className="text-lg font-semibold text-gray-700 mb-4">Contact & Healthcare</h3>
              <dl className="space-y-3">
                <div>
                  <dt className="text-sm font-medium text-gray-500">Address</dt>
                  <dd className="text-sm text-gray-700">{entry.address || 'N/A'}</dd>
                </div>
                <div>
                  <dt className="text-sm font-medium text-gray-500">Country</dt>
                  <dd className="text-sm text-gray-700">{entry.country || 'N/A'}</dd>
                </div>
                <div>
                  <dt className="text-sm font-medium text-gray-500">Postal Code</dt>
                  <dd className="text-sm text-gray-700">{entry.postalCode || 'N/A'}</dd>
                </div>
                <div>
                  <dt className="text-sm font-medium text-gray-500">Healthcare Number</dt>
                  <dd className="text-sm text-gray-700">{entry.healthcareNumber || 'N/A'}</dd>
                </div>
                <div>
                  <dt className="text-sm font-medium text-gray-500">Healthcare Province</dt>
                  <dd className="text-sm text-gray-700">{entry.healthcareProvince || 'N/A'}</dd>
                </div>
              </dl>
            </div>
          </div>
          ...
          <div className="mt-6 pt-6 border-t border-gray-200">
            <h3 className="text-lg font-semibold text-gray-700 mb-4">Waitlist Information</h3>
            <dl className="space-y-3">
              <div>
