        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-12">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
            {practiceFeatures.map((feature, index) => (
              <div
                key={index}
                className="bg-gray-50 rounded-xl p-5 sm:p-6 text-center transition-all duration-300 border border-gray-100 hover:shadow-md"
              >
      ...
      <section className="bg-gray-50 py-10 sm:py-10">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-12 text-center">
          ...
          <div className="relative">
            <div className="overflow-hidden">
              ...
              >
                {services.map((service, index) => (
                  ...
                  >
                    <div className="bg-white rounded-2xl p-6 sm:p-10 text-center shadow-sm border border-gray-100">
                      <div className="w-12 h-12 sm:w-16 sm:h-16 bg-gray-100 rounded-full flex items-center justify-center mx-auto mb-3 sm:mb-5">
                        <svg
                          className="w-6 h-6 sm:w-8 sm:h-8 text-cyan-600"
                          fill="none"
                          stroke="currentColor"
            ...
            <button
              onClick={nextService}
              className="absolute right-0 top-1/2 -translate-y-1/2 translate-x-2 sm:translate-x-4 lg:translate-x-6 w-8 h-8 sm:w-10 sm:h-10 bg-white border border-gray-200 rounded-full shadow-md hover:bg-gray-50 transition-all flex items-center justify-center"
            >
              <svg
                className="w-4 h-4 sm:w-5 sm:h-5 text-gray-600"
                fill="none"
            ...
            <div className="flex justify-center space-x-1 sm:space-x-2 mt-6 sm:mt-8">
              {services.map((_, index) => (
                <button
                  key={index}
                  onClick={() => setCurrentServiceIndex(index)}
                  className={`transition-all duration-200 rounded-full ${index === currentServiceIndex ? "w-6 sm:w-8 h-1 bg-gray-700" : "w-1 h-1 sm:w-1.5 sm:h-1.5 bg-gray-300 hover:bg-gray-400"}`}
                />
              ))}
            </div>
          </div>
            ...
            <div className="text-center lg:text-left">
              ...
              <div className="bg-white rounded-2xl p-5 sm:p-6 max-w-md mx-auto lg:mx-0 border border-gray-100">
                <div className="space-y-3 sm:space-y-4">
                  {/* Address */}
                  <div className="flex items-start space-x-3">
                    <div className="w-8 h-8 sm:w-10 sm:h-10 bg-gray-100 rounded-lg flex items-center justify-center flex-shrink-0 mt-0.5">
                      <svg
                        className="w-4 h-4 sm:w-5 sm:h-5 text-cyan-600"
                        fill="none"
                        stroke="currentColor"
