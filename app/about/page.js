    ...
    { 
      ...
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M12 14l9-5-9-5-9 5 9 5z" />
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M12 14v6l9-5-9-5-9 5 9 5z" />
        </svg>
      )
    },
    { 
  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-6xl mx-auto px-8 lg:px-12">
          <div className="text-center lg:text-left max-w-4xl mx-auto lg:mx-0">
            ...
            <h1 className="text-3xl lg:text-4xl xl:text-5xl font-bold text-gray-900 leading-tight tracking-tight mb-6">
              ...
              <span className="text-red-600">Family Clinic</span>
            </h1>
            <div className="w-16 h-1 bg-red-600 rounded-full mb-6 mx-auto lg:mx-0"></div>
            <p className="text-lg text-gray-600 mb-6 leading-relaxed">
              Providing compassionate, comprehensive family medicine to the Ottawa community with 
              personalized care from experienced physicians.
            </p>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-8 lg:px-12">
          <div className="text-center max-w-3xl mx-auto mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">Meet Our Physician</h2>
          ...
          {/* <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
            ...
            <div className="bg-white rounded-2xl border border-gray-100 transition-all duration-300 overflow-hidden">
              <div className="p-2 lg:text-left">
                <div className="mb-6">
                  <div className="w-16 h-1 bg-red-600 rounded-full mb-4 mx-auto lg:mx-0"></div>
                  <h3 className="text-2xl font-bold text-gray-900 mb-2">Dr. Oluwaseun Fagbolagun</h3>
                  <p className="text-red-600 font-medium mb-4">Family Physician</p>
                ...
                <div className="space-y-4 mt-6 pt-4 border-t border-gray-100">
                  {credentials.map((credential, index) => (
                    <div key={index} className="flex flex-col items-center lg:flex-row lg:items-start space-y-3 lg:space-y-0 lg:space-x-4">
                      <div className="flex-shrink-0 w-10 h-10 bg-red-50 rounded-xl flex items-center justify-center text-red-600">
                        {credential.icon}
                      </div>
          ...
          <div className="mt-12 bg-gray-50 rounded-2xl p-8 border border-gray-100">
            <h3 className="text-2xl font-bold text-gray-900 mb-6 text-center lg:text-left">Our Practice Philosophy</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {values.map((value, index) => (
                <div key={index} className="flex flex-col md:flex-row items-center md:items-start text-center md:text-left space-y-3 md:space-y-0 md:space-x-4">
      ...
      <section className="py-20 bg-red-50/20">
        <div className="max-w-7xl mx-auto px-8 lg:px-12">
          <div className="text-center max-w-3xl mx-auto mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">Practice Features</h2>
            <div className="w-12 h-1 bg-red-600 rounded-full mx-auto mb-6"></div>
            <p className="text-gray-600">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {practiceFeatures.map((feature, index) => (
              <div key={index} className="bg-white rounded-xl p-6 text-center transition-all duration-300 border border-gray-100 group">
                <div className="w-14 h-14 bg-red-50 rounded-xl flex items-center justify-center mx-auto mb-4 group-hover:bg-red-600 group-hover:scale-105 transition-all duration-300">
        ...
        <div className="max-w-7xl mx-auto px-8 lg:px-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="bg-gray-50 rounded-2xl p-8">
              ...
              <h2 className="text-2xl font-bold text-gray-900 mb-4 text-center lg:text-left">Our Mission</h2>
              <div className="w-12 h-1 bg-red-600 rounded-full mb-6 mx-auto lg:mx-0"></div>
              ...
              <div className="bg-white rounded-xl p-6 border border-gray-100">
                <h3 className="font-semibold text-gray-900 mb-3 text-center lg:text-left">Our Commitment</h3>
                <ul className="space-y-2">
                  ...
                  <li className="flex items-center justify-center lg:justify-start text-gray-600">
                    <svg className="w-4 h-4 mr-3 text-red-600 flex-shrink-0" fill="currentColor" viewBox="0 0 24 24">
                      <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                    </svg>
            ...
            <div className="bg-gray-50 rounded-2xl p-8">
              ...
              <h2 className="text-2xl font-bold text-gray-900 mb-4 text-center lg:text-left">Our Vision</h2>
              <div className="w-12 h-1 bg-red-600 rounded-full mb-6 mx-auto lg:mx-0"></div>
              <p className="text-gray-600 leading-relaxed mb-6">
      ...
      <section className="bg-red-600 py-16">
        <div className="max-w-4xl mx-auto px-8 lg:px-12 text-center">
          <h2 className="text-3xl font-bold text-white mb-4">Ready to become a patient?</h2>
          <p className="text-white/90 mb-8">Join our family of satisfied patients and experience compassionate care.</p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href="/appointment"
              className="inline-flex items-center justify-center px-6 py-3 rounded-xl bg-white text-red-600 font-semibold hover:bg-gray-100 transition-all duration-200 shadow-sm"
            >
              Book Appointment
