    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto px-8 lg:px-12">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-lg text-gray-600 leading-relaxed max-w-2xl mx-auto">
              Select the option that best fits your needs. Same-day appointments available for urgent care.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto px-4 lg:px-12">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {options.map((option) => (
              ...
              >
                {/* Icon */}
                <div className="w-14 h-14 bg-red-50 rounded-xl flex items-center justify-center mb-6 group-hover:bg-red-600 group-hover:scale-105 transition-all duration-300">
                ...
                <Link
                  href={option.link}
                  className="block text-center py-3 px-6 rounded-xl font-semibold text-base bg-red-600 text-white hover:bg-red-700 transition-all duration-200 shadow-sm hover:shadow-md"
                >
                  {option.buttonText}
            ...
            <div className="bg-gray-50 rounded-2xl p-8 max-w-2xl mx-auto">
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                ...
                <a 
                  ...
                  className="inline-flex items-center justify-center text-sm font-semibold text-red-600 bg-red-50 hover:bg-red-600 hover:text-white transition-all duration-200 rounded-full px-6 py-2.5"
                >
              ...
              <p className="text-xs text-gray-500 mt-4">
                Our staff is available to help you choose the right appointment type
              </p>
            </div>
          </div>
          ...
          <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="text-center p-4">
              ...
              <h4 className="font-semibold text-gray-900 mb-1">Same-Day Appointments</h4>
              <p className="text-xs text-gray-500">Available for urgent care needs</p>
            </div>
            <div className="text-center p-4">
              <div className="w-10 h-10 bg-red-50 rounded-lg flex items-center justify-center mx-auto mb-3">
                <svg className="w-5 h-5 text-red-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <p className="text-xs text-gray-500">Most services are covered by OHIP</p>
            </div>
            <div className="text-center p-4">
              <div className="w-10 h-10 bg-red-50 rounded-lg flex items-center justify-center mx-auto mb-3">
                <svg className="w-5 h-5 text-red-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <h4 className="font-semibold text-gray-900 mb-1">Central Location</h4>
              <p className="text-xs text-gray-500">1280 Trim Rd, Unit B, Orleans, ON K4A 3N3</p>
            </div>
          </div>
        </div>
      </main>
      ...
      <section className="bg-red-600 py-16">
        <div className="max-w-4xl mx-auto px-8 lg:px-12 text-center">
          <h2 className="text-3xl font-bold text-white mb-4">Need Immediate Medical Attention?</h2>
          <p className="text-white/90 mb-8">For urgent medical concerns, please call us or visit our clinic directly.</p>
