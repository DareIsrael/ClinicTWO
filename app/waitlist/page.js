      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8 pb-16">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-6 md:p-8">
            ...
            <form onSubmit={handleSubmit}>
              ...
              <p className="text-center text-xs text-gray-400 mt-4">
                By joining, you agree to our privacy policy. No spam,
                unsubscribe anytime.
              </p>
            </form>
          </div>
          ...
          <div className="space-y-6">
            {/* Main Benefits Card */}
            <div className="bg-gradient-to-br from-cyan-300 to-cyan-700 rounded-2xl p-6 md:p-8 text-white">
              ...
              <h2 className="text-2xl font-bold mb-2">Priority Access</h2>
              <p className="text-cyan-100 text-sm mb-6">
                Join our waitlist and get exclusive benefits
              </p>
                ...
                {[
                  {
                    ...
                    desc: "Be the first to know when spots open",
                  },
                  {
                    title: "Simple Process",
                    desc: "Fill out the form in under 2 minutes",
                  },
                  {
                    title: "No Obligation",
                    desc: "Join for free, unsubscribe anytime",
                  },
                  {
                    title: "Secure & Safe",
            ...
            <div className="bg-white rounded-xl border border-gray-100 p-5 shadow-sm">
              ...
              <p className="text-gray-600 text-sm italic">
                "Easy process! Got notified within 1 week and now I'm a
                registered patient."
              </p>
