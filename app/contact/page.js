...
export default function ContactPage() {
  ...
  const contactInfo = [
    ...
    },
    {
      ...
      title: 'Opening Hours',
      details: ['Mon-Thu: 10am - 7pm', 'Friday: 10am - 5pm', 'Saturday: 10am - 3pm'],
    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-6xl mx-auto px-6 lg:px-12">
          <div className="max-w-3xl">
            ...
            <h1 className="text-3xl lg:text-4xl xl:text-5xl font-bold text-gray-900 leading-tight tracking-tight mb-4">
              Contact<br />
              <span className="text-red-600">Trim Medical Centre</span>
            </h1>
            <div className="w-16 h-1 bg-red-600 rounded-full mb-5"></div>
            <p className="text-lg text-gray-600 leading-relaxed">
              We're here to help you with all your healthcare needs. Get in touch with us today 
              for appointments, inquiries, or medical concerns.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {contactInfo.map((info, index) => (
              <div key={index} className="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-all duration-300 border border-gray-100 group">
                ...
                {info.description && (
                  <p className="text-xs text-red-600 font-medium mt-2">{info.description}</p>
                )}
              </div>
            ))}
          </div>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
            ...
            <div className="bg-white rounded-2xl p-6 shadow-md border border-gray-100">
              ...
              <div className="w-12 h-1 bg-red-600 rounded-full mb-5"></div>
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full bg-red-600 text-white py-3.5 px-6 rounded-xl hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-600 focus:ring-offset-2 disabled:opacity-50 transition duration-300 font-semibold"
                >
                  {loading ? (
            ...
            <div className="space-y-5">
              ...
              <div className="bg-white rounded-2xl p-5 shadow-md border border-gray-100">
                ...
                <div className="bg-gray-100 h-56 rounded-xl flex items-center justify-center">
                  <div className="text-center text-gray-500">
                    <svg className="w-14 h-14 mx-auto mb-2 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1} d="M9 20l-5.447-2.724A1 1 0 013 16.382V5.618a1 1 0 011.447-.894L9 7m0 13l6-3m-6 3V7m6 10l4.553 2.276A1 1 0 0021 18.382V7.618a1 1 0 00-.553-.894L15 4m0 13V4m0 0L9 7" />
                    </svg>
                    <p className="font-medium text-gray-700">Interactive Map</p>
                    <p className="text-xs text-gray-500 mt-1">1280 Trim Rd, Unit B, Orleans, ON K4A 3N3</p>
                  </div>
                </div>
              ...
              <div className="bg-red-50 border border-red-200 rounded-2xl p-5">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <h3 className="text-base font-semibold text-red-800 mb-1">Medical Emergency</h3>
                    ...
                    <div className="text-base font-bold text-red-800">Call 911 for Emergencies</div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-red-50/30 rounded-2xl p-5 border border-red-200">
                <h3 className="text-base font-semibold text-gray-900 mb-3">Quick Contact</h3>
                <div className="space-y-2">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <a href="tel:3438873470" className="text-gray-900 font-medium hover:text-red-600 transition-colors text-sm">(343) 224-4070</a>
                    </div>
                  </div>
                  <div className="flex items-center space-x-3">
                    <div className="w-7 h-7 bg-red-100 rounded-lg flex items-center justify-center">
                    ...
                    <div>
                      ...
                      <a href="mailto:contact@trimmedicalcenter.ca" className="text-gray-900 font-medium hover:text-red-600 transition-colors text-xs">contact@trimmedicalcenter.ca</a>
                    </div>
                  </div>
                  <div className="flex items-center space-x-3">
                    <div className="w-7 h-7 bg-red-100 rounded-lg flex items-center justify-center">
                    ...
                    <div>
                      ...
                      <p className="text-gray-900 font-medium text-sm">(888) 615-1221</p>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <section className="bg-red-600 py-12">
        <div className="max-w-4xl mx-auto px-6 lg:px-12 text-center">
          <h2 className="text-2xl lg:text-3xl font-bold text-white mb-3">Need Immediate Assistance?</h2>
          <p className="text-white/90 mb-6">Call us directly to speak with our friendly staff about appointments or inquiries.</p>
          <a
            href="tel:+13438873470"
            className="inline-flex items-center justify-center px-6 py-2.5 rounded-xl bg-white text-red-600 font-semibold hover:bg-gray-100 transition-all duration-200 shadow-md"
          >
