...
export default function WaitingListConfirmation() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-cyan-30 to-cyan-50 flex items-center justify-center p-6">
      <div className="w-full max-w-xs">
        <div className="bg-white rounded-xl shadow-sm border border-cyan-100 p-6">
          ...
          <Link 
            href="/"
            className="w-full bg-cyan-600 text-white py-2 px-3 rounded-lg text-xs font-medium hover:bg-cyan-700 focus:outline-none focus:ring-1 focus:ring-red-500 transition duration-200 block text-center"
          >
            Back to Home
          </Link>
