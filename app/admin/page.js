...
export default function AdminDashboard() {
  ...
  const tabs = [
    ...
    { id: 'waitlist-broadcast', label: 'Waitlist Broadcast', icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
      </svg>
    ) },
    { id: 'appointment-broadcast', label: 'Appointment Broadcast', icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
      </svg>
    ) },
    { id: 'broadcast-history', label: 'Broadcast History', icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
      </svg>
    ) },
              ...
              <nav className="bg-white rounded-lg shadow-md overflow-hidden sticky top-6">
                ...
                <div className="py-2">
                  {tabs.map((tab) => (
                    ...
                    >
                      <span className={`flex-shrink-0 ${activeTab === tab.id ? 'text-red-600' : 'text-gray-400'}`}>
                        {tab.icon}
                      </span>
